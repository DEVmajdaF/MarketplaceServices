...
namespace MarketplaceServices.Migrations
{
    ...
    [Migration("20210924140330_Addonetoonechatmodels")]
    partial class Addonetoonechatmodels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketplaceServices.Models.ChatMessages", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MarketplaceServices.Models.ChatRooms", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MarketplaceServices.Models.RoomUser", b =>
                {
            ...
            modelBuilder.Entity("MarketplaceServices.Models.ChatMessages", b =>
                {
                    b.HasOne("MarketplaceServices.Models.ChatRooms", "Room")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MarketplaceServices.Models.RoomUser", b =>
                {
                    b.HasOne("MarketplaceServices.Models.ApplicationUser", "Users")
                        .WithMany("Rooms")
                        .HasForeignKey("UsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarketplaceServices.Models.ChatRooms", "rooms")
                        .WithMany("Users")
